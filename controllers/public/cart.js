                    ...
                    response.dataset.map(function (row) {
                        ...
                        content += `
                            <tr>
                                ...
                                <td>
                                    <a onclick="openUpdateDialog(${row.id_detalle}, ${row.cantidad})" class="btn waves-effect blue tooltipped" data-tooltip="Cambiar">
                                        <i class="material-icons">exposure</i>
                                    </a>
                                    <a onclick="openDeleteDialog(${row.id_detalle})" class="btn waves-effect red tooltipped" data-tooltip="Remover">
